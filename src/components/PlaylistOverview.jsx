...
const PlaylistOverview = () => {
   return (
      <div className='max-md:mt-5 max-sm:mt-3 max-sm:flex-col max-sm:items-center max-sm:justify-center flex items-end mt-7'>
         <img className='max-2xl:w-[235px] max-md:w-[190px] max-md:mr-4 max-sm:w-full max-sm:max-w-md max-sm:mr-0 max-w-full mr-8' src={photo} alt="Playlist" />
         <div className='text-white w-full max-sm:mt-5'>
            <p className='text-xl font-medium max-sm:hidden'>PUBLIC PLAYLIST</p>
            <h1 className='max-2xl:text-[100px] max-2xl:leading-[132px] text-[122px] max-md:text-[80px] max-md:leading-[112px] max-sm:text-3xl max-sm:font-semibold max-sm:leading-10 leading-[154px] tracking-tighter font-bold'>Chill Mix</h1>
