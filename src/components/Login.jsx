...
const Login = () => {
   ...
   return (
      <div className="bg-black flex justify-center w-full h-full fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 z-[100]">
         <div className="w-full max-w-[600px] bg-[#ffffff] text-black p-5 rounded-lg fixed top-2/4 left-2/4 -translate-x-2/4 -translate-y-2/4 z-20">
            ...
            <div className="flex items-center justify-end w-full">
               <a href={`${AUTH_ENDPOINT}?client_id=${CLIENT_ID}&redirect_uri=${REDIRECT_URI}&response_type=${RESPONSE_TYPE}`} className="w-full max-w-[200px]">
                  <button className="bg-[#21c367] py-1 w-full rounded-lg font-bold text-white">Log in</button>
               </a >
            </div>
         </div>
      </div>
