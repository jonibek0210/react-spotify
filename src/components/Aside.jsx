                  ...
                  <ul className="flex max-lg:items-center max-lg:justify-around lg:flex-col max-lg:gap-0 gap-6 text-[#aaaaaa]">
                     <li className=''>
                        <NavLink
                           ...
                           <span className='text-lg font-bold max-lg:text-[14px]'>Home</span>
                        </NavLink>
                     </li>
                     <li className=''>
                        <NavLink
                           ...
                           <span className='text-lg font-bold max-lg:text-[14px]'>Search</span>
                        </NavLink>
                     </li>
                     <li className=''>
                        <NavLink
                           ...
                           <span className='text-lg font-bold max-lg:text-[14px]'>Your Library</span>
                        </NavLink>
                     </li>
                     <li className='max-lg:mt-0 mt-8 max-lg:hidden'>
                        <NavLink
                           ...
                           <span className='text-lg font-bold max-lg:text-[14px]'>Create Playlist</span>
                        </NavLink>
                     </li>
                     <li className='max-lg:hidden'>
                        <NavLink
                           ...
                           <span className='text-lg font-bold max-lg:text-[14px]'>Liked Songs</span>
                        </NavLink>
                     </li>
                  </ul>
               </nav>
