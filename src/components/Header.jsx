   ...
   return (
      <header className="max-lg:py-4 max-sm:py-3 text-white py-5 flex items-center justify-between">
         <div className="flex items-center">
            ...
            <button onClick={() => navigate(1)} className="max-sm:hidden p-[4px] bg-[#00000090] rounded-full">
               <IoIosArrowForward size='32' />
            </button>
            <p className="max-sm:block hidden text-2xl font-semibold">hello world</p>
         </div>
         <div className="max-sm:flex max-sm:gap-2 max-sm: w-fit">
            ...
            <Link>
               <button className="hidden max-sm:block" ><SlBell size="25px" color="#ffffff" /></button>
            </Link>
            <Link>
               <button className="hidden max-sm:block" ><BsClockHistory size="25px" color="#ffffff" /></button>
            </Link>
            <Link>
               <button className="hidden max-sm:block" ><FiSettings size="25px" color="#ffffff" /></button>
            </Link>
         </div>
      </header>
   );
